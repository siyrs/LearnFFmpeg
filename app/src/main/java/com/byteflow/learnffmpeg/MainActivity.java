...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int PIXEL_PET_GAME_EXAMPLE = 9;
            ...
            public void onItemClick(View view, int position) {
                ...
                switch (position) {
                    ...
                    case FF_MEDIACODEC_PLAYER:
                        ...
                        break;
                    case PIXEL_PET_GAME_EXAMPLE:
                        startActivity(new Intent(MainActivity.this, PixelPetActivity.class));
                        break;
                        default:
                            break;
                }
